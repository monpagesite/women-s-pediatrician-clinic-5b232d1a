...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-32" ref={contentRef}>
        <div className="max-w-2xl">
          ...
          {/* CTA Row */}
          <div className="hero-reveal opacity-0 translate-y-8 transition-all duration-700 ease-out flex flex-col sm:flex-row items-stretch sm:items-center gap-4 sm:gap-6 mb-12">
            <a
              href="#book"
